...
Lovi.prototype.start = function() {
  ...
  // Read bindings
  configx.loadConfigsInFolder(C.DIR_BINDINGS_CONFIG, function(content) {
  ...
  // Read schedules
  configx.loadConfigsInFolder(C.DIR_SCHEDULES_CONFIG, function(content) {
  ...
  function bindingInitialized(bindingUri) {
    ...
    configx.loadConfigsInFolder(C.DIR_RESOURCES_CONFIG, function(content) {
